...
class PaymentEventHandler {
    private final PaymentApplicationService service; private final DemoPaymentProvider provider; private final ApplicationEventPublisher events; private final Clock clock;
    PaymentEventHandler(PaymentApplicationService service,DemoPaymentProvider provider,ApplicationEventPublisher events,Clock clock){this.service=service;this.provider=provider;this.events=events;this.clock=clock;}
